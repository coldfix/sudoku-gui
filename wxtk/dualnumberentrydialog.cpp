...
////@begin DualNumberEntryDialog member initialisation
    ...
    m_prompt0 = "Number 1:";
    m_prompt1 = "Number 2:";
    m_numinfo0 = wxtk::SpinInfo(0,0,100);
    m_numinfo1 = wxtk::SpinInfo(0,0,100);
...
////@begin DualNumberEntryDialog content construction
    ...
    itemSpinCtrl8->SetValidator( wxtk::SpinValidator(& m_numinfo0) );
    itemStaticText9->SetValidator( wxGenericValidator(& m_prompt1) );
    itemSpinCtrl11->SetValidator( wxtk::SpinValidator(& m_numinfo1) );
